...
void setup() {
  ...
  //ICR1 = 80;//PWM mode counts up and back down for 80 counts

  //OCR1A = 41; //Pin 9 match
...
void setFreq(float newFreq){ //Går att skicka in som lägst 245 Hz annars överstiger det 65536 (2^16)
  freq= newFreq;
  ...
  OCR1A = freqValueA;
  OCR1B = freqValueB;
  Serial.println(String(freq,1) + ": " + freqValue);
  }
